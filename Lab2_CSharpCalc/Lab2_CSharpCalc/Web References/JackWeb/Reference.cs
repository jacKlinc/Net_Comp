...
namespace Lab2_CSharpCalc.JackWeb {
    using System;
    ...
    public partial class MyWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback SquaredMethodOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public MyWebService() {
            this.Url = global::Lab2_CSharpCalc.Properties.Settings.Default.Lab2_CSharpCalc_localhost_MyWebService;
        ...
        /// <remarks/>
        public event SquaredMethodCompletedEventHandler SquaredMethodCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SquaredMethod", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public float SquaredMethod(float sqNum) {
            object[] results = this.Invoke("SquaredMethod", new object[] {
                        sqNum});
            return ((float)(results[0]));
        }
        
        /// <remarks/>
        public void SquaredMethodAsync(float sqNum) {
            this.SquaredMethodAsync(sqNum, null);
        }
        
        /// <remarks/>
        public void SquaredMethodAsync(float sqNum, object userState) {
            if ((this.SquaredMethodOperationCompleted == null)) {
                this.SquaredMethodOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSquaredMethodOperationCompleted);
            }
            this.InvokeAsync("SquaredMethod", new object[] {
                        sqNum}, this.SquaredMethodOperationCompleted, userState);
        }
        
        private void OnSquaredMethodOperationCompleted(object arg) {
            if ((this.SquaredMethodCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SquaredMethodCompleted(this, new SquaredMethodCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3190.0")]
    public delegate void SquaredMethodCompletedEventHandler(object sender, SquaredMethodCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3190.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SquaredMethodCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SquaredMethodCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
